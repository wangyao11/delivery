...
public class DeliveryUserProductMapperDao {
    ...
    public DeliveryUserProductMapper getByUserIdAndProductIdAndDeliveryItemId(DeliveryUserProductParam deliveryUserProductParam) {
        return deliveryUserProductMapperMapper.getByUserIdAndProductIdAndDeliveryItemId(deliveryUserProductParam);
    }
